...
{
    switch (error) {
        case EMMC_OK:               return "Success";
        case EMMC_ERROR:            return "General error";
        case EMMC_TIMEOUT:          return "Timeout";
        case EMMC_CRC_ERROR:        return "CRC error";
        case EMMC_BUSY:             return "Device busy";
        case EMMC_NOT_READY:        return "Not ready";
        case EMMC_INVALID_PARAM:    return "Invalid parameter";
        case EMMC_NOT_SUPPORTED:    return "Not supported";
